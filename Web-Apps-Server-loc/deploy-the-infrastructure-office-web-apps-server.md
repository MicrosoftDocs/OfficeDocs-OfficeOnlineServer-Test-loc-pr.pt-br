---
title: 'Implantar a infraestrutura: Servidor do Office Web Apps'
TOCTitle: 'Implantar a infraestrutura: Servidor do Office Web Apps'
ms:assetid: ec93a103-8072-435f-9e80-897c0aa7b914
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/JJ219458(v=office.15)
ms:contentKeyID: 49647137
ms.date: 01/04/2018
mtps_version: v=office.15
ms.translationtype: HT
---

# Implantar a infraestrutura: Servidor do Office Web Apps
...
**Resumo:** contém artigos sobre o Servidor do Office Web Apps e como ele oferece funcionalidade dos Office Web Apps aos hosts.

**Público:** profissionais de TI

Servidor do Office Web Apps é um novo produto de servidor do Office que fornece versões baseadas em navegador do Word, do PowerPoint, do Excel e do OneNote. Um único farm do Office Web Apps pode suportar usuários que acessam arquivos do Office por meio do SharePoint 2013, do Lync Server 2013, do Exchange Server 2013, de pastas compartilhadas e sites. O novo modelo de implantação autônomo significa que você pode gerenciar atualizações ao seu farm do Servidor do Office Web Apps independentemente de outros produtos do Office Server implantados em sua organização.

![Logotipo do Office 2013](images/JJ219456.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Logotipo do Office 2013")Os artigos na tabela a seguir são destinados aos profissionais de TI que planejam configurar o Servidor do Office Web Apps no local em suas organizações.

### Artigos sobre o Servidor do Office Web Apps na TechNet
...
<tbody>
<tr class="odd">
<td><p><a href="office-web-apps-server-overview.md">Visão geral do Servidor do Office Web Apps</a></p></td>
<td><p>Aprenda como o Servidor do Office Web Apps fornece funcionalidades do Office baseadas em navegador para hosts locais em sua organização.</p></td>
</tr>
<tr class="even">
<td><p><a href="plan-office-web-apps-server.md">Planejar-se para o Servidor do Office Web Apps</a></p></td>
<td><p>Aprenda sobre os requisitos do Servidor do Office Web Apps, como HTTPS, certificados, virtualização, balanceamento de carga, topologias e segurança.</p></td>
</tr>
<tr class="odd">
<td><p><a href="deploy-office-web-apps-server.md">Implantar o Servidor do Office Web Apps</a></p></td>
<td><p>Aprenda a implantar o Servidor do Office Web Apps no local.</p></td>
</tr>
<tr class="even">
<td><p><a href="technical-reference-for-office-web-apps-server.md">Referência técnica para o Office Web Apps Server</a></p></td>
<td><p>Encontre referências técnicas para Servidor do Office Web Apps. Isso inclui ajuda para o cmdlets OfficeWebApps Windows PowerShell.</p></td>
</tr>
</tbody>
</table>
