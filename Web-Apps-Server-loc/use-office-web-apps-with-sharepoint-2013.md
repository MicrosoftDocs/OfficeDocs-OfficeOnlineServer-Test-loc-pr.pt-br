---
title: Usar o Office Web Apps com o SharePoint 2013
TOCTitle: Usar o Office Web Apps com o SharePoint 2013
ms:assetid: 8a58e6c2-9a0e-4355-ae41-4df25e5e6eee
ms:mtpsurl: https://technet.microsoft.com/pt-br/library/Ee855124(v=office.15)
ms:contentKeyID: 49647113
ms.date: 02/08/2018
mtps_version: v=office.15
ms.translationtype: MT
---

# Usar o Office Web Apps com o SharePoint 2013
...
**Resumo:** Contém artigos que lhe ajudam a aprender como implantar e configurar o Office Web Apps para SharePoint 2013 local.

**Audiência:** profissionais de TI

Quando usado com SharePoint 2013 local, Office Web Apps fornece versões atualizadas do Word Web App, Excel Web App, PowerPoint Web App e OneNote Web App. Os usuários podem exibir e, opcionalmente, editar documentos Office usando um navegador da web com suporte em computadores e em diferentes dispositivos móveis, como Windows Phones, iPhones e iPads. Além dos novos recursos no Office Web Apps, os métodos de implantação e arquitetura também alterou, que permitem Office Web Apps fornecer funcionalidade de visualização de Lync Server 2013.

![Logotipo do Office 2013](images/JJ219456.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Logotipo do Office 2013")Os artigos na tabela a seguir são destinados aos profissionais de TI que planejam configurar o SharePoint 2013 a fim de usar o Office Web Apps no local em suas organizações.

### Artigos sobre o Office Web Apps no TechNet
...
<tbody>
<tr class="odd">
<td><p><a href="how-office-web-apps-work-on-premises-with-sharepoint-2013.md">Como o Office Web Apps funciona no local com o SharePoint 2013</a></p></td>
<td><p>Fornece informações sobre o Office Web Apps, como obtê-las e como elas funcionam no local com o SharePoint 2013.</p></td>
</tr>
<tr class="even">
<td><p><a href="what’s-new-with-office-web-apps-when-used-with-sharepoint-2013.md">O que há de novo em relação ao Office Web Apps quando utilizado com o SharePoint 2013?</a></p></td>
<td><p>Descreve os novos recursos disponíveis para os usuários e administradores do SharePoint 2013 ao utilizar o Office Web Apps.</p></td>
</tr>
<tr class="odd">
<td><p><a href="plan-office-web-apps-used-with-sharepoint-2013.md">Planejar o Office Web Apps (usado com os produtos do SharePoint 2013)</a></p></td>
<td><p>Fornece orientação de planejamento para o Office Web Apps quando ele é usado com o SharePoint 2013.</p></td>
</tr>
<tr class="even">
<td><p><a href="configure-office-web-apps-for-sharepoint-2013.md">Configurar o Office Web Apps para o SharePoint 2013</a></p></td>
<td><p>Fornece informações sobre como configurar o SharePoint 2013 para usar o Office Web Apps em um ambiente de teste.</p></td>
</tr>
<tr class="odd">
<td><p><a href="set-the-default-open-behavior-for-browser-enabled-documents-office-web-apps-when-used-with-sharepoint-2013.md">Definir o comportamento padrão de abertura para documentos habilitados para navegadores (Office Web Apps quando usados com o SharePoint 2013)</a></p></td>
<td><p>Fornece informações sobre como configurar o comportamento padrão de abertura para documentos do Office nos conjuntos de sites do SharePoint e em bibliotecas de documentos.</p></td>
</tr>
<tr class="even">
<td><p><a href="video-configure-office-web-apps-for-sharepoint-2013.md">VÍdeo: Configurar o Office Web Apps para o SharePoint 2013</a></p></td>
<td><p>Apresenta as nove principais etapas para configurar um farm do Servidor do Office Web Apps para funcionar com o SharePoint 2013.</p></td>
</tr>
<tr class="odd">
<td><p><a href="technical-reference-for-office-web-apps-with-sharepoint-2013.md">Referência técnica para o Office Web Apps (com o SharePoint 2013)</a></p></td>
<td><p>Fornece links para artigos de referência técnica, como ajuda para os cmdlets SPWOPI Windows PowerShell para Office Web Apps.</p></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><p></p>
<img src="images/JJ219457.22cad0f4-303d-4a40-90a3-fa08e69dfdaf(Office.15).png" title="Ícone de novidades (caixa)" alt="Ícone de novidades (caixa)" /></td>
<td><p><strong>Conteúdo publicado recentemente</strong></p></td>
<td><p>Consulte o seguinte artigo para obter uma lista de artigos do Office Web Apps novos ou atualizados recentemente.</p>
<ul>
...
<tr class="even">
<td><p></p>
<img src="images/Dn135237.6b2d6dfa-7dc8-40fb-8335-af68b575f8cb(Office.15).png" title="Introdução" alt="Introdução" /></td>
<td><p><strong>Introdução</strong></p></td>
<td><p>Baixe o Servidor do Office Web Apps.</p>
<ul>
<li><p><a href="https://go.microsoft.com/fwlink/p/?linkid=256561">(VLSC) do Centro de atendimento de licenciamento por volume</a></p>
...
<ul>
<li><p><a href="https://go.microsoft.com/fwlink/p/?linkid=263945">Centro de Download da Microsoft</a></p></li>
</ul>
<p>Explore esses links para saber como implementar o Servidor do Office Web Apps e o SharePoint 2013.</p>
<ul>
...
<tr class="odd">
<td><p></p>
<img src="images/JJ219456.6fa793ee-ede9-4476-901c-de96ea37fc3a(Office.15).png" title="Ícone de chat" alt="Ícone de chat" /></td>
